...
from ...visualization.visualize import create_artificial, init_umap, plot_pca, plot_umap
...
class GANTrainerSetup(BaseTrainerSetup):
    ...
    def train_step(self, engine, batch):
        ...
        disc_loss_fake = self.loss_function(disc_fake, torch.zeros_like(disc_fake))
